                            ...
                            <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                <div>
                                    <div class="logo-wrapper">
                                        ...
                                        <h3 class="text-primary invoice-logo">Store Konecta</h3>
                                    </div>
                                    <p class="card-text mb-25">Bogota Colombia</p>
                                    <p class="card-text mb-0">Av. Pepe Sierra #71D - 46, Bogotá</p>
                                </div>
                                <div class="mt-md-0 mt-2">
                                    <h4 class="invoice-title">
                                        Factura
                                        <span class="invoice-number">#{{ $productSale->id }}</span>
                                    </h4>
                                    <div class="invoice-date-wrapper">
                                        <p class="invoice-date-title">Fecha de factura:</p>
                                        <p class="invoice-date">{{ $productSale->created_at }}</p>
                                    </div>
                        ...
                        <div class="card-body invoice-padding pt-0">
                            <div class="row invoice-spacing">
                                <div class="col-xl-8 p-0">
                                    ...
                                    <p class="card-text mb-25">Correo electronico</p>
                                ...
                                <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><span class="fw-bold">{{ $productSale->user->name }}</span></td>
                                            </tr>
                                            <tr>
                                                
                                                <td>{{ $productSale->user->email }}</span></td>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="py-1">
                                            ...
                                            <p  class="card-text fw-bold text-nowrap">
                                                {{ $productSale->product->name_product }}
                                                <small>
                                                    {{ $productSale->product->reference }}

                                                </small>
                                                <span class="badge badge-light-primary">
                                                    #{{ $productSale->category->name_category }}
                ...
                <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-outline-primary w-100 btn-download-invoice mb-75 waves-effect">Imprimir</button>
